...
it is your job to create a quiz of {number} \
...
template2 = """
You are an expert english grammarial and writer. Given a Multiple Choice Quiz for {subject} students. \
You need to evaluate the complexity of the question and give a complete analysis of the quiz. Only use at max 50 words for complexity.
If the quiz is not at per with the cognitive and analytical abilities of the students,\
update the quiz questions which needs to be changed and change the tone such that it perfectly fits the student abilities.
Return the quiz with the format RESPONSE_JSON below.
If no change is needed, return the quiz with the format RESPONSE_JSON below.
Quiz_MCQs:
{quiz}
